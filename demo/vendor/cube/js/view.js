define(['zepto', 'underscore', 'backbone', 'cube/list', 'cube/calendar', 'cube/segment', 'cube/carousel', 'cube/extendable-list', 'cube/session','cube/base64-img'],
    function($, _, Backbone, List, Calendar, Segment, Carousel, ExtendableList, Session, Base64Img){
    ...
    var CubeView = Backbone.View.extend({
        ...
        compile: function(){
            ...
            // var searchbar = SearchBar.compile(this);
