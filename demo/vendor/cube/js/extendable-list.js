 ...
 *
 */
 define(['zepto', 'underscore', 'cube/cube-loader', 'cube/cache', 'iscroll.lite', 'backbone','cube/list'], function($, _, Loader, Cache, iScroll, Backbone,List){
    ...
    var ExtendableList  = List.extend({
        ...
        onItemSelect: function(e){
            ...
            var extendLi = $('.cube-extend-view')[index];
        ...
        loadListByJSONArray : function(jsonArray){
            ...
            for (var i = 0; i < jsonArray.length; i++) {
                ...
                for(var j = 0; j < extendArray.length; j++){
                    ...
                    //TODO: 需要重构
                var container = document.getElementById(me.id).querySelector('.contentScroller .item-content');
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR){
                    ...
                    if(null === jsonRoot){
                        ...
                        if(_itemTemplateName) _.template(templateStr, jsonRoot).appendTo(contentEL);
                    }else{
        ...
        compile: function(el){
            var me = this;
            return _.map($(el).find("extendablelist"), function(tag){
