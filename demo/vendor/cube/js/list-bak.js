    ...
    var List  = Backbone.View.extend({
        ...
        onItemSelect: function(e){
            ...
            if(this.shouldPreventListEvent(nodeName)){
                ...
                this.trigger("select", this, {data: data, index: index, event: e});
            }
        },
        ...
        compile: function(elContext){
            ...
            return _.map($(elContext).find("list"), function(tag){
                ...
                var config = me.parseConfig(tag, ['id', 'itemTemplate', '_itemTemplate', 'moreItemElement', 'url', 'method', 'jsonRoot', 'class', 'paging', 'iScroll', 'autoLoad', 'pageParam','searching','searchkeys','filterStr','pageSize','skin']);
