...
define(['zepto', 'underscore'], function($, _){
    ...
    var btnElem =    '<a href="javascript:void(0)" class="btn cube-dialog-btn ui-shadow ui-btn-corner-all ui-btn-icon-left" eventname="abcd">'
    ...
    Dialog.prototype.calculatePosition = function(){
            ...
            $(wrapper).height(top);
            dialog.css("top", (top/2) - 80 +"px");       //设置到当前窗口中间 
